...
public final class JsonParserTest {
    ...
    public void rejectsStringWithInvalidEscapedUnicodeChars() throws Exception {
        ...
        try {
            new JsonParser().parse(new StringReader(inputString), BLACK_HOLE_LISTENER);
    ...
    public void tokenizesValidNumber() throws Exception {
        ...
        new JsonParser().parse(new StringReader("[12.123E-2]"), jsonListener);
    ...
    public void tokenizesSimpleJsonStringObject() throws Exception {
        ...
        new JsonParser().parse(new StringReader("{\"hello\":\"world\"}"), jsonListener);
        context.assertIsSatisfied();
    }
    ...
    public void tokenizesMultiElementArrayWithWhitespace() throws Exception {
        ...
        new JsonParser().parse(new StringReader("[ 1, 2 ]"), jsonListener);
        context.assertIsSatisfied();
    }
    ...
    public void tokenizesJsonStringObjectPair() throws Exception {
        ...
        new JsonParser().parse(new StringReader("{\"hello\":\"world\",\"foo\":\"bar\"}"), jsonListener);
        context.assertIsSatisfied();
    }
    ...
    public void tokenizesSimpleJsonNumberValue() throws Exception {
        ...
        new JsonParser().parse(new StringReader("{\"room\":101}"), jsonListener);
        context.assertIsSatisfied();
    }
    ...
    public void tokenizesSimpleJsonNull() throws Exception {
        ...
        new JsonParser().parse(new StringReader("{\"points\":null}"), jsonListener);
        context.assertIsSatisfied();
    }
    ...
    public void tokenizesSimpleJsonTrue() throws Exception {
        ...
        new JsonParser().parse(new StringReader("{\"points\":true}"), jsonListener);
        context.assertIsSatisfied();
    }
    ...
    public void tokenizesSimpleJsonFalse() throws Exception {
        ...
        new JsonParser().parse(new StringReader("{\"points\":false}"), jsonListener);
        context.assertIsSatisfied();
    }
    ...
    public void tokenizesJsonNumberValuePair() throws Exception {
        ...
        new JsonParser().parse(new StringReader("{\"room\":101,\"answer\":42}"), jsonListener);
        context.assertIsSatisfied();
    }
    ...
    public void tokenizesJsonMixedPair() throws Exception {
        ...
        new JsonParser().parse(new StringReader("{\"room\":101,\"foo\":\"bar\"}"), jsonListener);
        context.assertIsSatisfied();
    }
    ...
    public void tokenizesEmptyObject() throws Exception {
        ...
        new JsonParser().parse(new StringReader(inputString), jsonListener);
        context.assertIsSatisfied();
    }
    ...
    public void tokenizesObjectWithArrayValue() throws Exception {
        ...
        new JsonParser().parse(new StringReader("{\"Test\":[12]}"), jsonListener);
        context.assertIsSatisfied();
    }
    ...
    private void assertJsonValueFragmentResultsInStringValue(final String jsonFragment, final String expectedStringValue) throws IOException, JsonListenerException {
        ...
        new JsonParser().parse(new StringReader("[" + jsonFragment + "]"), jsonListener);
        context.assertIsSatisfied();
    }
