...
public final class TokenizerTest {
    ...
    public void rejectsStringWithInvalidEscapedUnicodeChars() throws Exception {
        ...
        try {
            new Tokenizer().json(new StringReader(inputString), BLACK_HOLE_LISTENER);
    ...
    public void tokenizesValidNumber() throws Exception {
        ...
        new Tokenizer().json(new StringReader("[12.123E-2]"), jsonListener);
    ...
    public void tokenizesSimpleJsonStringObject() throws Exception {
        ...
        new Tokenizer().json(new StringReader("{\"hello\":\"world\"}"), jsonListener);
        context.assertIsSatisfied();
    }
    ...
    public void tokenizesMultiElementArrayWithWhitespace() throws Exception {
        ...
        new Tokenizer().json(new StringReader("[ 1, 2 ]"), jsonListener);
        context.assertIsSatisfied();
    }
    ...
    public void tokenizesJsonStringObjectPair() throws Exception {
        ...
        new Tokenizer().json(new StringReader("{\"hello\":\"world\",\"foo\":\"bar\"}"), jsonListener);
        context.assertIsSatisfied();
    }
    ...
    public void tokenizesSimpleJsonNumberValue() throws Exception {
        ...
        new Tokenizer().json(new StringReader("{\"room\":101}"), jsonListener);
        context.assertIsSatisfied();
    }
    ...
    public void tokenizesSimpleJsonNull() throws Exception {
        ...
        new Tokenizer().json(new StringReader("{\"points\":null}"), jsonListener);
        context.assertIsSatisfied();
    }
    ...
    public void tokenizesSimpleJsonTrue() throws Exception {
        ...
        new Tokenizer().json(new StringReader("{\"points\":true}"), jsonListener);
        context.assertIsSatisfied();
    }
    ...
    public void tokenizesSimpleJsonFalse() throws Exception {
        ...
        new Tokenizer().json(new StringReader("{\"points\":false}"), jsonListener);
        context.assertIsSatisfied();
    }
    ...
    public void tokenizesJsonNumberValuePair() throws Exception {
        ...
        new Tokenizer().json(new StringReader("{\"room\":101,\"answer\":42}"), jsonListener);
        context.assertIsSatisfied();
    }
    ...
    public void tokenizesJsonMixedPair() throws Exception {
        ...
        new Tokenizer().json(new StringReader("{\"room\":101,\"foo\":\"bar\"}"), jsonListener);
        context.assertIsSatisfied();
    }
    ...
    public void tokenizesEmptyObject() throws Exception {
        ...
        new Tokenizer().json(new StringReader(inputString), jsonListener);
        context.assertIsSatisfied();
    }
    ...
    public void tokenizesObjectWithArrayValue() throws Exception {
        ...
        new Tokenizer().json(new StringReader("{\"Test\":[12]}"), jsonListener);
        context.assertIsSatisfied();
    }
    ...
    private void assertJsonValueFragmentResultsInStringValue(final String jsonFragment, final String expectedStringValue) throws IOException {
        final JsonListener jsonListener = context.mock(JsonListener.class);
        final Sequence expectedSequence = context.sequence("expectedSequence");
        context.checking(new Expectations() {{
            oneOf(jsonListener).startDocument(); inSequence(expectedSequence);
        ...
        new Tokenizer().json(new StringReader("[" + jsonFragment + "]"), jsonListener);
        context.assertIsSatisfied();
    }
