...
public final class StajBasedJdomParser {
     ...
     * @throws java.io.IOException bubbled up from exceptions thrown reading from the specified <code>Reader</code>.
     ...
     * @throws argo.saj.InvalidSyntaxException
     *          if the characters streamed from the specified <code>String</code> does not represent valid JSON.
     */
