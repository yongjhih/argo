...
public final class TokenizerTest {
    ...
    public void rejectsStringWithInvalidEscapedUnicodeChars() throws Exception {
        ...
        try {
            new Tokenizer(BLACK_HOLE_LISTENER).json(new StringReader(inputString));
    ...
    public void tokenizesValidNumber() throws Exception {
        ...
        new Tokenizer(jsonListener).json(new StringReader("[12.123E-2]"));
    ...
    public void tokenizesSimpleJsonStringObject() throws Exception {
        ...
        new Tokenizer(jsonListener).json(new StringReader("{\"hello\":\"world\"}"));
        context.assertIsSatisfied();
    }
    ...
    public void tokenizesMultiElementArrayWithWhitespace() throws Exception {
        ...
        new Tokenizer(jsonListener).json(new StringReader("[ 1, 2 ]"));
        context.assertIsSatisfied();
    }
    ...
    public void tokenizesJsonStringObjectPair() throws Exception {
        ...
        new Tokenizer(jsonListener).json(new StringReader("{\"hello\":\"world\",\"foo\":\"bar\"}"));
        context.assertIsSatisfied();
    }
    ...
    public void tokenizesSimpleJsonNumberValue() throws Exception {
        ...
        new Tokenizer(jsonListener).json(new StringReader("{\"room\":101}"));
        context.assertIsSatisfied();
    }
    ...
    public void tokenizesSimpleJsonNull() throws Exception {
        ...
        new Tokenizer(jsonListener).json(new StringReader("{\"points\":null}"));
        context.assertIsSatisfied();
    }
    ...
    public void tokenizesSimpleJsonTrue() throws Exception {
        ...
        new Tokenizer(jsonListener).json(new StringReader("{\"points\":true}"));
        context.assertIsSatisfied();
    }
    ...
    public void tokenizesSimpleJsonFalse() throws Exception {
        ...
        new Tokenizer(jsonListener).json(new StringReader("{\"points\":false}"));
        context.assertIsSatisfied();
    }
    ...
    public void tokenizesJsonNumberValuePair() throws Exception {
        ...
        new Tokenizer(jsonListener).json(new StringReader("{\"room\":101,\"answer\":42}"));
        context.assertIsSatisfied();
    }
    ...
    public void tokenizesJsonMixedPair() throws Exception {
        ...
        new Tokenizer(jsonListener).json(new StringReader("{\"room\":101,\"foo\":\"bar\"}"));
        context.assertIsSatisfied();
    }
    ...
    public void tokenizesObjectWithArrayValue() throws Exception {
        ...
        new Tokenizer(jsonListener).json(new StringReader("{\"Test\":[12]}"));
        context.assertIsSatisfied();
    }
    ...
    private void assertJsonValueFragmentResultsInStringValue(final String jsonFragment, final String expectedStringValue) throws IOException {
        ...
        new Tokenizer(jsonListener).json(new StringReader("[" + jsonFragment + "]"));
        context.assertIsSatisfied();
    }
